...
public class Page8 extends AppCompatActivity {
    ...
    private int CORRECT_MAX = 9;
    private int INCORRECT_MAX = 9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionTextView.setText(R.string.pig);
        ...
        topLeftTextView.setText(R.string.page8_top_left_image_view);
        topRightTextView.setText(R.string.page8_top_right_image_view);
        bottomLeftTextView.setText(R.string.page8_bottom_left_image_view);
        bottomRightTextView.setText(R.string.page8_bottom_right_image_view);
    ...
    private void loadPageCorrect(int correct, int incorrect){
        Intent loadCorrect = new Intent(getApplicationContext(), Page9.class);
