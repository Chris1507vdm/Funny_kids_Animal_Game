...
public class Page2 extends AppCompatActivity {
    private int CORRECT_MAX = 3;
    private int INCORRECT_MAX = 3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scoreIncorrect = load.getIntExtra("incorrect", scoreIncorrect);

        scoreCorrect = load.getIntExtra("correct", scoreCorrect);


        scoreIncorrect = scoreIncorrect;
        scoreCorrect = scoreCorrect;

        questionTextView.setText(R.string.dog);
        ...
        topRightImageView.setBackgroundResource(R.drawable.badger);
        bottomLeftImageView.setBackgroundResource(R.drawable.cat);
        bottomRightImageView.setBackgroundResource(R.drawable.bird);
        ...
        topLeftTextView.setText(R.string.page2_top_left_image_view);
        topRightTextView.setText(R.string.page2_top_right_image_view);
        bottomLeftTextView.setText(R.string.page2_bottom_left_image_view);
        bottomRightTextView.setText(R.string.page2_bottom_right_image_view);


        topLeftImageView.setOnClickListener(loadCorrectAnswer);
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.dog_bark);
        playAudioWithDelay();
    ...
    // Move to next page once button is clicked
    ...
    private void loadPageCorrect(int correct, int incorrect){
        Intent loadCorrect = new Intent(getApplicationContext(), Page3.class);
