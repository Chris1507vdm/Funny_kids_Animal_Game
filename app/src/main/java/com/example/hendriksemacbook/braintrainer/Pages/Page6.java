...
public class Page6 extends AppCompatActivity {
    ...
    private int CORRECT_MAX = 7;
    private int INCORRECT_MAX = 7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionTextView.setText(R.string.cow);
        ...
        topLeftTextView.setText(R.string.page6_top_left_image_view);
        topRightTextView.setText(R.string.page6_top_right_image_view);
        bottomLeftTextView.setText(R.string.page6_bottom_left_image_view);
        bottomRightTextView.setText(R.string.page6_bottom_right_image_view);
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.cow_moo);
        playAudioWithDelay();
    }
    ...
    private void loadPageCorrect(int correct, int incorrect){
        Intent loadCorrect = new Intent(getApplicationContext(), Page7.class);
