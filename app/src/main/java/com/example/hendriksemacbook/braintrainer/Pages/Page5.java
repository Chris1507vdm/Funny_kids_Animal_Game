...
public class Page5 extends AppCompatActivity {
    ...
    private int CORRECT_MAX = 6;
    private int INCORRECT_MAX = 6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionTextView.setText(R.string.chicken);
        ...
        topLeftImageView.setBackgroundResource(R.drawable.pig);
        topRightImageView.setBackgroundResource(R.drawable.swan);
        bottomLeftImageView.setBackgroundResource(R.drawable.chicken);
        ...
        topLeftTextView.setText(R.string.page5_top_left_image_view);
        topRightTextView.setText(R.string.page5_top_right_image_view);
        bottomLeftTextView.setText(R.string.page5_bottom_left_image_view);
        bottomRightTextView.setText(R.string.page5_bottom_right_image_view);

        topLeftImageView.setOnClickListener(loadIncorrectAnswer);
        topRightImageView.setOnClickListener(loadIncorrectAnswer);
        bottomLeftImageView.setOnClickListener(loadCorrectAnswer);
        bottomRightImageView.setOnClickListener(loadIncorrectAnswer);

        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.chicken_cluck);
        playAudioWithDelay();
    }
    ...
    private void loadPageCorrect(int correct, int incorrect){
        Intent loadCorrect = new Intent(getApplicationContext(), Page6.class);
