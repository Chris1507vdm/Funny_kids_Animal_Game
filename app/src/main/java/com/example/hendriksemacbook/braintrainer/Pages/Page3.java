...
public class Page3 extends AppCompatActivity {
    ...
    private int INCORRECT_MAX = 4;
    private int CORRECT_MAX = 4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionTextView.setText(R.string.lion);
        ...
        topLeftImageView.setBackgroundResource(R.drawable.mouse);
        topRightImageView.setBackgroundResource(R.drawable.baby_panda);
        bottomLeftImageView.setBackgroundResource(R.drawable.lion);
        ...
        topLeftTextView.setText(R.string.page3_top_left_image_view);
        topRightTextView.setText(R.string.page3_top_right_image_view);
        bottomLeftTextView.setText(R.string.page3_bottom_left_image_view);
        bottomRightTextView.setText(R.string.page3_bottom_right_image_view);
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.lion_growl);
        playAudioWithDelay();
    }
    ...
    private void loadPageCorrect(int correct, int incorrect){
        Intent loadCorrect = new Intent(getApplicationContext(), Page4.class);
