...
public class Page4 extends AppCompatActivity {
    ...
    private int CORRECT_MAX = 5;
    private int INCORRECT_MAX = 5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionTextView.setText(R.string.cat);
        ...
        topRightImageView.setBackgroundResource(R.drawable.penguin);
        bottomLeftImageView.setBackgroundResource(R.drawable.owl);
        bottomRightImageView.setBackgroundResource(R.drawable.cat);
        ...
        topLeftTextView.setText(R.string.page4_top_left_image_view);
        topRightTextView.setText(R.string.page4_top_right_image_view);
        bottomLeftTextView.setText(R.string.page4_bottom_left_image_view);
        bottomRightTextView.setText(R.string.page4_bottom_right_image_view);
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.cat_meow);
        playAudioWithDelay();
    }
    ...
    private void loadPageCorrect(int correct, int incorrect){
        Intent loadCorrect = new Intent(getApplicationContext(), Page5.class);
